...
The source for JekyllFaces.com, and what I hope with be the official copy of the JekyllFaces code and resources.
...
baseurl: "/jekyllfaces.com" # the subpath of your site, e.g. /blog
```

... to this ...

```yaml
url: "https://jekyllfaces.com" # the base hostname & protocol for your site, e.g. http://example.com
